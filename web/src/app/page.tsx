      ...
      <footer className="relative z-10 border-t border-white/10" style={{ backgroundColor: '#1C1411' }}>
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              <h3 className="text-lg font-semibold text-white mb-4">Randevum</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/terms" className="text-sm text-slate-300/70 hover:text-white transition-colors">
                    Kullanım Koşulları
                  </Link>
                </li>
                <li>
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-8 text-sm text-slate-200/60 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3 text-white">
            <span className="flex h-9 w-9 items-center justify-center rounded-full text-sm font-semibold text-white" style={{ background: 'linear-gradient(to bottom right, #2d0a0a, #1a0a0a, #0a0505)' }}>
              Rv
            </span>
            Randevum © {new Date().getFullYear()}
          </div>
