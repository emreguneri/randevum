            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-12 rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
                ...
                <p className="text-sm text-slate-200/70">
                  Lütfen sayfayı yenileyin veya daha sonra tekrar deneyin. Sorun devam ederse{" "}
                  <a href="/#contact" className="text-amber-300 hover:text-amber-200 transition underline">
                    destek ekibimizle
                  </a>{" "}
                  iletişime geçin.
                </p>
